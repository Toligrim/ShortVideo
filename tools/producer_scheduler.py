...
2. Сценарист → режиссёр → озвучка → критик → рендер — все шаги скилла produce,
   включая проверки и право вето: gap-скан ≤3 без новых визуалов — не
   пропускай; но и мега-компонент на >6 фаз под один ролик, где ≥2 подряд
   сцены идут одной картинкой со сменой подписей — верни режиссёру. Вердикт
   критика «БРАК ТЕМЫ» (тема без глубины / переигранная рамка) — НЕ отдавай
   режиссёру и НЕ переигрывай ту же тему: останови сдачу и напиши причину в
   сводке.
